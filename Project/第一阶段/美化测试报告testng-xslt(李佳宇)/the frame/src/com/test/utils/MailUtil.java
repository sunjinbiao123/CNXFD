...
// 			String filename = "D:\\eclipse-workspace\\the frame\\test-output\\index.html";
 			String filename2 = "D:\\eclipse-workspace\\the frame\\test-output\\navigation.html";
 			DataSource source2 = new FileDataSource(filename2);
 			messageBodyPart2.setDataHandler(new DataHandler(source2));
 			String filename3 = "D:\\eclipse-workspace\\the frame\\test-output\\overview.html";
 			DataSource source3 = new FileDataSource(filename3);
 			BodyPart messageBodyPart3 = new MimeBodyPart();
 			messageBodyPart3.setDataHandler(new DataHandler(source3));
 			String filename4 = "D:\\eclipse-workspace\\the frame\\test-output\\Default suite.html";
